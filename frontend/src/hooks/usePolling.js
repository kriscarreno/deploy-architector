...
/**
 * @param {() => Promise<any>} fn        - Función a ejecutar periódicamente
 * @param {{ interval?: number, enabled?: boolean, onSuccess?: (data:any)=>void, onError?: (err:any)=>void }} opts
 */
function usePolling(
  fn,
  { interval = 2000, enabled = true, onSuccess, onError } = {},
) {
